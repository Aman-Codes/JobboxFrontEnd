...
export default function MyPendingJobs() {
    ...
    const loadJobs = () => {
        ...
        axios({
            method: 'POST',
            url: `${process.env.REACT_APP_API}/recruiter/jobs/pending/page/${currentPage}`,
            headers: {
    ...
    const loadPages = () => {
        ...
        axios({
            method: 'POST',
            url: `${process.env.REACT_APP_API}/recruiter/jobs/pending/pagecount`,
            headers: {
                Authorization: `Bearer ${token}`
            },
            data: {RecruiterId}
