...
export default function AppliedCandidateList() {
    ...
    const loadCandidates = () => {
        axios({
            method: 'POST',            
            url: `${process.env.REACT_APP_API}/recruiter/jobs/applied-candidate-list/${jobId}/${currentPage}`,
            headers: {
    ...
    const loadPages = () => {
        axios({
            method: 'POST',
            url: `${process.env.REACT_APP_API}/recruiter/jobs/applied-candidate-list/pagecount/${jobId}`,
            headers: {
                Authorization: `Bearer ${token}`
            },
            data: {RecruiterId}
        ...
        <React.Fragment>   
            ...
            <div className="row">
                <div className="col-md-12 mx-auto">
                    <h1 className="text-center mb-5">Applied Candidates</h1>
